export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'creativezila',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Creativezila',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'creativezila.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://creativezila.com',
