...
// Shared navy/beige palette — warm beige surfaces, deep navy text, medium
// blue-gray accents. All detail views inherit this via --tk-* tokens.
const base = {
  dark: false,
